...
public class PermGreedyCampusOneExtra {

    private CampusModelOneExtra campusOneExtra;
    ...
    public PermGreedyCampusOneExtra() {
	initModel();
    }

    private void initModel() {
	campusOneExtra = new CampusModelOneExtra();
	...
	sb.append("\n\n---------TALLY TEST----------\n\n");
	sb.append("\n----------NUM RUNS - " + numRuns + "-------\n");
	sb.append("\n---------PERM v. GREEDY CAMPUS MODEL ONE w/ EXTRA SPOTS (100 drivers, 117 spots)----------\n\n");
	...
	sb.append("\n\nFOR CAMPUS ONE (additional 17 spaces):\n");
	sb.append("\nPERMUTATION WINS " + "\n\nAVERAGE >> " + pmWins[0] + "\nWORST >> " + pmWins[1] + "\nBEST >> " + pmWins[2] + "\n\n");
	sb.append("\nGREEDY ONLINE WINS " + "\n\nAVERAGE >> " + goWins[0] + "\nWORST >> " + goWins[1] + "\nBEST >> " + goWins[2]);
	try {
	...
	PermGreedyCampusOneExtra pgc1e = new PermGreedyCampusOneExtra();
	pgc1e.test();
    }
}