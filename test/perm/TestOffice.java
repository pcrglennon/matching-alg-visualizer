...
/**
 * Runs Max-Flow, Opt Bottleneck,  both New Algs, and Greedy on the Office Model
 *
 * Optimal Threshold for Office  = 14
 */
...
sb.append("\n\n-----------------------AVERAGE BOTTLENECK COSTS:-----------------------\n\n");
	...
	sb.append("\n\nGREEDY WINS " + "\n\nAVERAGE >> " + goWins[0] + "\nWORST >> " + goWins[1] + "\nBEST >> " + goWins[2]);
	try {
	    FileWriter fstream = new FileWriter("results/OFFICE_RESULTS.txt");
