...
/**
 * Runs Max-Flow, Opt Bottleneck,  both New Algs, and Greedy on Campus Model 2
 *
 * Optimal Threshold for Campus 2  = 20
 */

public class TestCampusTwo {
...
sb.append("\n\n-----------------------AVERAGE BOTTLENECK COSTS:-----------------------\n\n");
	...
	sb.append("\n\nGREEDY WINS " + "\n\nAVERAGE >> " + goWins[0] + "\nWORST >> " + goWins[1] + "\nBEST >> " + goWins[2]);
	try {
	    FileWriter fstream = new FileWriter("results/CAMPUS_TWO_RESULTS.txt");
	...
	TestCampusTwo tc2 = new TestCampusTwo();
	tc2.test();
    }
}